...
<xsl:transform version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:v3="urn:hl7-org:v3" xmlns:str="http://exslt.org/strings" xmlns:exsl="http://exslt.org/common" xmlns:msxsl="urn:schemas-microsoft-com:xslt"
	...
	<xsl:template name="include-custom-items">
		<script src="https://ajax.googleapis.com/ajax/libs/jquery/3.2.1/jquery.min.js" type="text/javascript" charset="utf-8"/>
		<script src="https://code.jquery.com/ui/1.12.1/jquery-ui.js" type="text/javascript" charset="utf-8"/>
		<script src="{$resourcesdir}jqxcore.js" type="text/javascript" charset="utf-8"/>
		<script src="{$resourcesdir}jqxsplitter_spm.js" type="text/javascript" charset="utf-8"/>
		<script src="{$resourcesdir}hpfb-spm.js" type="text/javascript" charset="utf-8"/>
	</xsl:template>
