...
function add2Nodes(){
	temp = $("#toc").append(
			$("<div style='float:left;'>&nbsp;&nbsp;&nbsp;</div><h1 style='white-space:nowrap;'><a href='#prodDesc'>" + $("#prodDesc tbody tr th").html() + "</a></h1>")
			).append(
				$("<div style='float:left;'>&nbsp;&nbsp;&nbsp;</div><h1 style='white-space:nowrap;'><a href='#organizations'>" + $("#organizations tbody tr th").html() + "</a></h1>")
			);
}
